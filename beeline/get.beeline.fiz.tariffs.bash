...
# Переменные:
extracto_dir="EL_EXTRACTO/"		# Каталог, в котором хранятся экстракты (выборки) из описаний тарифных планов
arc_dir="EL_EXTRACTO/ARC/"		# Каталог, в котором хранятся архивные экстракты (выборки) из описаний тарифных планов
